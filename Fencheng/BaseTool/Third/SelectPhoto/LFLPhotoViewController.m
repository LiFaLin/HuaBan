...
#import "LFLPhotoViewController.h"
#import <AVFoundation/AVFoundation.h>
#import "PhotoClipView.h"
@interface LFLPhotoViewController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
@implementation LFLPhotoViewController
- (PhotoClipView *)clipView{
    
    if (!_clipView) {
        
        _clipView = [[PhotoClipView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height-100)];
...
- (void)customCamera{
    ...
    self.previewLayer.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight-100);
...
- (void) shutterCamera
{
    ...
    [self.ImageOutPut captureStillImageAsynchronouslyFromConnection:videoConnection completionHandler:^(CMSampleBufferRef imageDataSampleBuffer, NSError *error) {
        ...
        UIImage * lflimage = [self.image fixOrientation]; //修正图片方向
        [self.session stopRunning];
        [self.view addSubview:self.clipView];
         self.clipView.image = lflimage;
