...
#import "header.h"
#import "LFLView.h"
@interface EditDraftViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UICollectionViewDelegateFlowLayout,TencentSessionDelegate>{
...
@property (nonatomic, strong) NSString *lflName;
...
- (void)viewDidLoad {
    ...
    for(NSString *key in [dictionary allKeys]){
        if ([key containsString:self.TemplateId]) {
            [array addObject:[self objectValueWith:key]];
            [array1 addObject:key];
        }
    }
    [FCAppInfo shareManager].draftArr=array;
    [FCAppInfo shareManager].draftNameArr=array1;
    ...
    [FCAppInfo shareManager].temID=self.TemplateId;
    self.lflName=[FCAppInfo shareManager].lflTemName;
    ...
    [_DataCollectionView registerClass:[DOneCell class] forCellWithReuseIdentifier:@"cellid1"];
    [_DataCollectionView registerClass:[DTwoCell class] forCellWithReuseIdentifier:@"cellid2"];
    [_DataCollectionView registerClass:[DThreeCell class] forCellWithReuseIdentifier:@"cellid3"];
    [_DataCollectionView registerClass:[DFourCell class] forCellWithReuseIdentifier:@"cellid4"];
    [_DataCollectionView registerClass:[DFiveCell class] forCellWithReuseIdentifier:@"cellid5"];
    [_DataCollectionView registerClass:[DSixCell class] forCellWithReuseIdentifier:@"cellid6"];
    [_DataCollectionView registerClass:[DSevenCell class] forCellWithReuseIdentifier:@"cellid7"];
    [_DataCollectionView registerClass:[DRightCell class] forCellWithReuseIdentifier:@"cellid8"];
    [_DataCollectionView registerClass:[DNineCell class] forCellWithReuseIdentifier:@"cellid9"];
    [_DataCollectionView registerClass:[DTenoCell class] forCellWithReuseIdentifier:@"cellid10"];
    ...
    else
    {
        ...
        UIAlertAction *confirm = [UIAlertAction actionWithTitle:@"是" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            [arr1 enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                if ([obj[@"radom"] isEqualToString:self.TemplateId]) {
                    *stop = YES;
            ...
            NSDictionary * dic=@{@"TemplateId":self.TemplateId1,@"TemplateName":self.lflName,@"radom":self.TemplateId,@"date":dateString,@"image":string,@"boxColor":boxColor,@"fontColor":[FCAppInfo shareManager].TDic,@"huaban":[FCAppInfo shareManager].huabanArr,@"qietu":self.qietuData,@"portroy":[FCAppInfo shareManager].pDic,@"backgroundimage":[FCAppInfo shareManager].backgroundImage};
        ...
        UIAlertAction *cance=[UIAlertAction actionWithTitle:@"否" style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
            ...
            NSMutableArray *draftArr=[FCAppInfo shareManager].draftArr;
            NSMutableArray *draftArr1=[FCAppInfo shareManager].draftNameArr;
            [draftArr enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop){
               [self setValueName:obj withKey:draftArr1[idx]];
            }];
...
-(void)upDetail{
    ...
    NSDictionary *lfldic=@{@"AccessToken":AccessToken,@"Scrapbook":jsonString,@"Picture":jianqie,@"ScrapbookName":self.lflName};
    
    NSString *lflstring= [self createSign:lfldic];
    
    NSDictionary *param=@{@"Sign":lflstring,@"Scrapbook":jsonString,@"Picture":jianqie,@"ScrapbookName":self.lflName};
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([string isEqualToString:@"1"]) {
        DOneCell *cell1 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid1" forIndexPath:indexPath];
        ...
        DTwoCell *cell2 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid2" forIndexPath:indexPath];
        ...
        DThreeCell *cell3 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid3" forIndexPath:indexPath];
        ...
        DFourCell *cell4 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid4" forIndexPath:indexPath];
        ...
        DFiveCell *cell5 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid5" forIndexPath:indexPath];
        ...
        if (dic.count>2) {
            ...
            cell5.bottomLabel.textColor=UIColorFromHex([dic[@"Color"] intValue]);
            cell5.bottomLabel.textAlignment=NSTextAlignmentLeft;
            [stand setObject:dic forKey:[NSString stringWithFormat:@"5%@text",[FCAppInfo shareManager].temID]];
            [stand synchronize];
        }
        [cell5 setLFL];
        //        添加图片按钮的操作
        ...
        DSixCell *cell6 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid6" forIndexPath:indexPath];
        ...
        DRightCell *cell8 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid8" forIndexPath:indexPath];
        ...
        DSevenCell *cell7 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid7" forIndexPath:indexPath];
        ...
        DNineCell *cell9 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid9" forIndexPath:indexPath];
        ...
        DTenoCell *cell10 = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellid10" forIndexPath:indexPath];
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        if (textdic.count>2) {
            ...
            //            label.font=[UIFont systemFontOfSize:[textdic[@"Text"]intValue]];
            //            NSDictionary *tdic=[FCAppInfo shareManager].TDic;
            //            NSString *fontColor=[NSString stringWithFormat:@"%@",tdic[@"FontColor"]];
...
-(void)uploadgifOSS:(NSString*)imageName{
    ...
    NSDictionary *dic = [self objectValueWith:imageName];
    NSString *dataStr=dic[@"image"];
    NSData *data = [NSData dataWithContentsOfFile:dataStr];//可以使用上传到服务器或者其他的
    NSString *endpoint =[NSString stringWithFormat:@"https://%@",self.EndPoint] ;
    // 明文设置secret的方式建议只在测试时使用，更多鉴权模式请参考后面的`访问控制`章节
    id<OSSCredentialProvider> credential = [[OSSStsTokenCredentialProvider alloc] initWithAccessKeyId:self.accessKeyId secretKeyId:self.accessKeySecret securityToken:self.securityToken];
