...
#import "header.h"
#import "LFLView.h"
@interface cengjiDetailViewController ()
...
@implementation cengjiDetailViewController
...
//    yunxu=@"1";
    ...
    GIFArr = [NSMutableArray arrayWithCapacity:0];
    chooseVideo=NO;
    chooseImg=NO;
//    self.view.backgroundColor=[UIColor whiteColor];
    self.title=self.scrobookName;
...
-(void)changeImage:(NSNotification*)notification{
    ...
    if ([[FCAppInfo shareManager].isHeader isEqualToString:@"yes"]) {
        ...
        NSString *zuiIndex2=[NSString stringWithFormat:@"%@%@%@gif",self->lflimage,self->image1,self.ScrapbookId];
...
-(void)popLeftItemView{
    if ([IsBack isEqualToString:@"1"]) {
        ...
        for(NSString *key in [dictionary allKeys]){
            if ([key containsString:[NSString stringWithFormat:@"%@image",self.ScrapbookId]]||[key containsString:[NSString stringWithFormat:@"%@headerText",self.ScrapbookId]]||[key containsString:[NSString stringWithFormat:@"%@video",self.ScrapbookId]]||[key containsString:[NSString stringWithFormat:@"%@gif",self.ScrapbookId]]) {
...
-(void)gifwmy{
    ...
    NSDictionary *dictionary = [stand dictionaryRepresentation];
    for(NSString *key in [dictionary allKeys]){
        if ([key containsString:[NSString stringWithFormat:@"%@gif123",self.ScrapbookId]])
        {
            NSDictionary *dic = [self objectValueWith:key];
            NSString * gifString=dic[@"gifString"];
            NSString *firstFive=[gifString substringToIndex:5];
            NSString *endfour=[gifString substringFromIndex:gifString.length-4];
            if ([firstFive isEqualToString:@"https"]&&[endfour isEqualToString:@".gif"]) {
                ...
                if ([key containsString:@"imageheader"]) {
                    ...
                    else
                    {
                        ...
                        if([dic[@"image"] isKindOfClass:[NSString class]]){
                            [self->ImageArr addObject:[NSString stringWithFormat:@"%@%@",key,dic[@"image"]]];
                        }else{
                             [self uploadPictureOSS:key];
                        }
...
//                    NSString *wtextIndex2= [key stringByReplacingOccurrencesOfString:@"video" withString:@"gif"];
                   
                    
//                    NSString *lfl2=[NSString stringWithFormat:@"%@%@",wtextIndex2,dic[@"GifURL"]];
                    self->SureSum+=1;
                    [self->VideoArr addObject:lfl];
//                    self->gifCount+=1;
//                    if (lfl2.length>9) {
//                        [self->GIFArr addObject:lfl2];
//                    }
        ...
        else if ([key containsString:[NSString stringWithFormat:@"%@gif",self.ScrapbookId]])
        {
            NSDictionary *dic = [self objectValueWith:key];
            NSString * gifString=dic[@"gifString"];
            NSString *firstFive=[gifString substringToIndex:5];
            ...
            if ([firstFive isEqualToString:@"https"]&&[endfour isEqualToString:@".gif"]) {
                 self->gifCount +=1;
                 NSString *lfl=[NSString stringWithFormat:@"%@%@",key,gifString];
                 [self->GIFArr addObject:lfl];
            }else{
                self->gifCount +=1;
...
//                }
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                NSData *data=wDic1[@"image"];
                UIImage *image=[UIImage imageWithData:data];
                [cell2.addButton setBackgroundImage:image forState:UIControlStateNormal];
            }else{
                NSString *data=wDic1[@"image"];
                [cell2.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
            ...
            if ([wancheng isEqualToString:@"1"]) {
                ...
                NSString *VideoUrl;
                NSString *GIFIndex1=[NSString stringWithFormat:@"%ld1%@gif",indexPath.row+1,self.ScrapbookId];
                NSString *GifUrl;
                for (int i=0; i<GIFArr.count; i++){
                    
                    NSString * String=[GIFArr[i] substringToIndex:GIFIndex1.length];
                    if ([String isEqualToString:GIFIndex1]) {
                        NSRange range = [GIFArr[i] rangeOfString:@"https:"]; //现获取要截取的字符串位置
                        GifUrl = [GIFArr[i] substringFromIndex:range.location];
                    }
                }
                ...
                if (VideoUrl.length>9)
                {
                    ...
                    //添加数据
                    NSDictionary *image=@{@"ParameterType":@"VIDEO",@"VideoURL":VideoUrl,@"GifURL":GifUrl,@"VideoPictureURL":urlStr};
                    NSArray *arr=@[image];
...
//                [self setValueName:dic1 withKey:textIndex1];
                if ([wancheng isEqualToString:@"1"]) {
                    ...
                    if (VideoUrl.length>9)
                    {
                        ...
                        //添加数据
                        NSDictionary *image=@{@"ParameterType":@"VIDEO",@"VideoURL":VideoUrl,@"GifURL":GifUrl,@"VideoPictureURL":string};
                        NSArray *arr=@[image];
                        NSDictionary *zong=@{@"ModuleId":@"Module_1_2",@"Parameters":arr};
                        [pamaArr addObject:zong];
...
//                [self setValueName:dic withKey:textIndex];
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell3.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//            [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic2.count==1) {
            if (![wDic2[@"image"] isKindOfClass:[NSString class]]) {
                NSData *data=wDic2[@"image"];
                UIImage *image=[UIImage imageWithData:data];
                [cell3.add1Button setBackgroundImage:image forState:UIControlStateNormal];
            }else{
                NSString *data=wDic2[@"image"];
                [cell3.add1Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if ([wancheng isEqualToString:@"1"]) {
            ...
            NSString *VideoUrl;
            NSString *VideoUrl1;
            NSString *GIFIndex=[NSString stringWithFormat:@"%ld1%@gif",indexPath.row+1,self.ScrapbookId];
            NSString *GifUrl;
            NSString *GIFIndex1=[NSString stringWithFormat:@"%ld2%@gif",indexPath.row+1,self.ScrapbookId];
            NSString *GifUrl1;
            for (int i=0; i<GIFArr.count; i++){
                ...
                if ([String isEqualToString:GIFIndex]) {
                    ...
                    NSRange range = [GIFArr[i] rangeOfString:@"https:"]; //现获取要截取的字符串位置
                    GifUrl1 = [GIFArr[i] substringFromIndex:range.location];
                }else{
...
//            }
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell4.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if ([wancheng isEqualToString:@"1"]) {
            ...
            for (int i=0; i<GIFArr.count; i++){
                ...
                NSString * String=[GIFArr[i] substringToIndex:GIFIndex.length];
...
//            }
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell5.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic2.count==1) {
            if (![wDic2[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic2[@"image"];
                [cell5.add1Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic3.count==1) {
            if (![wDic3[@"image"] isKindOfClass:[NSString class]]) {
                NSData *data=wDic3[@"image"];
                UIImage *image=[UIImage imageWithData:data];
                [cell5.add2Button setBackgroundImage:image forState:UIControlStateNormal];
            }else{
                NSString *data=wDic3[@"image"];
                [cell5.add2Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if ([wancheng isEqualToString:@"1"]) {
            ...
            NSString *GIFIndex1=[NSString stringWithFormat:@"%ld2%@gif",indexPath.row+1,self.ScrapbookId];
            NSString *GifUrl1;
            NSString *GIFIndex2=[NSString stringWithFormat:@"%ld3%@gif",indexPath.row+1,self.ScrapbookId];
            NSString *GifUrl2;
            for (int i=0; i<GIFArr.count; i++){
                ...
                if ([String isEqualToString:GIFIndex]) {
                    ...
                    NSRange range = [GIFArr[i] rangeOfString:@"https:"]; //现获取要截取的字符串位置
                    GifUrl2 = [GIFArr[i] substringFromIndex:range.location];
                }else{
...
//                }
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell6.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic2.count==1) {
            if (![wDic2[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic2[@"image"];
                [cell6.add1Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic3.count==1) {
            if (![wDic3[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic3[@"image"];
                [cell6.add2Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell8.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic2.count==1) {
            if (![wDic2[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic2[@"image"];
                [cell8.add1Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic3.count==1) {
            if (![wDic3[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic3[@"image"];
                [cell8.add2Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic4.count==1) {
            if (![wDic4[@"image"] isKindOfClass:[NSString class]]) {
                NSData *data=wDic4[@"image"];
                UIImage *image=[UIImage imageWithData:data];
                [cell8.add3Button setBackgroundImage:image forState:UIControlStateNormal];
            }else{
                NSString *data=wDic4[@"image"];
                [cell8.add3Button sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if ([wancheng isEqualToString:@"1"]) {
            ...
            NSString *GIFIndex2=[NSString stringWithFormat:@"%ld3%@gif",indexPath.row+1,self.ScrapbookId];
            NSString *GifUrl2;
            NSString *GIFIndex3=[NSString stringWithFormat:@"%ld4%@gif",indexPath.row+1,self.ScrapbookId];
            NSString *GifUrl3;
            for (int i=0; i<GIFArr.count; i++){
                ...
                if ([String isEqualToString:GIFIndex]) {
                    ...
                    NSRange range = [GIFArr[i] rangeOfString:@"https:"]; //现获取要截取的字符串位置
                    GifUrl3 = [GIFArr[i] substringFromIndex:range.location];
                }else{
...
//                }
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell7.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                    [self setValueName:dic1 withKey:textIndex1];
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell9.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                }
        ...
        if (wDic1.count==1) {
            if (![wDic1[@"image"] isKindOfClass:[NSString class]]) {
                ...
                NSString *data=wDic1[@"image"];
                [cell10.addButton sd_setBackgroundImageWithURL:[NSURL URLWithString:data] forState:UIControlStateNormal];
            }
...
//                 [headerButton sd_setBackgroundImageWithURL:[NSURL URLWithString:wmy[@"image"]] forState:UIControlStateNormal];
            }else{
                NSArray *lfla=[FCAppInfo shareManager].huabanArr;
                NSDictionary *dic2=lfla[11];
                NSString *string=dic2[@"BackgroundImage"];
...
//                [headerButton sd_setBackgroundImageWithURL:[NSURL URLWithString:url] forState:UIControlStateNormal];
            }
...
//                [stand synchronize];
        ...
        if ([key containsString:[NSString stringWithFormat:@"%@gif",self.ScrapbookId]]) {
            NSLog(@"key==%@",key);
            NSRange range = [key rangeOfString:self.ScrapbookId];
            NSString *str = [key substringToIndex:range.location-1];
            NSString *first=[key substringToIndex:str.length];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    ...
    if (chooseImg)
    {
        ...
        if ([self getPictureData]+data.length/1024>1024*[[FCAppInfo shareManager].MaxXian intValue]) {
            ...
            NSString *zuiIndex=[NSString stringWithFormat:@"%@%@%@image",lflimage,image1,self.ScrapbookId];
            NSString *zuiIndex1=[NSString stringWithFormat:@"%@%@%@video",lflimage,image1,self.ScrapbookId];
            NSString *zuiIndex2=[NSString stringWithFormat:@"%@%@%@gif123",lflimage,image1,self.ScrapbookId];
...
-(void)uploadPictureOSS:(NSString*)imageName{
    ...
    [putTask continueWithBlock:^id(OSSTask *task) {
        if (!task.error) {
            ...
            NSLog(@"-上传图片的数量-%lu--%d",(unsigned long)self->GIFArr.count,self->gifCount);
            if (self->ImageArr.count==self->ZongSum&&self->VideoArr.count==self->SureSum&&self->GIFArr.count==self->gifCount) {
...
-(void)uploadVideoOSS:(NSString*)imageName{
    ...
    [putTask continueWithBlock:^id(OSSTask *task) {
        if (!task.error) {
            ...
            NSLog(@"-上传视频的数量-%lu--%d",(unsigned long)self->GIFArr.count,self->gifCount);
            if (self->ImageArr.count==self->ZongSum&&self->VideoArr.count==self->SureSum&&self->GIFArr.count==self->gifCount) {
...
-(void)uploadgifOSS:(NSString*)imageName{
    ...
    [putTask continueWithBlock:^id(OSSTask *task) {
        ...
        if (!task.error) {
            NSLog(@"gifUrl==%@",gifUrl);
            [self->GIFArr addObject:gifUrl];
            NSLog(@"-上传gif的数量-%lu--%d",(unsigned long)self->GIFArr.count,self->gifCount);
            if (self->ImageArr.count==self->ZongSum&&self->VideoArr.count==self->SureSum&&self->GIFArr.count==self->gifCount) {
                dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (status == AFNetworkReachabilityStatusReachableViaWiFi)
        {
            ...
            for(NSString *key in [dictionary allKeys]){
                if ([key containsString:[NSString stringWithFormat:@"%@image",self.ScrapbookId]]) {
                    ...
                    NSLog(@"Sumkey==%@",key);
                    if ([key containsString:[NSString stringWithFormat:@"%@image",self.ScrapbookId]]&&![key containsString:@"jianqie"]&&![key containsString:@"imageheader"]){
                        sumimage+=1;
                    }
                }
